...
# The cell library moved to extraction/cell_library.py on 2026-09-07.
# Everything below that this file used to define itself - the primitive
...
from cell_library import (          # noqa: F401  (re-exported for callers)
    ...
    NONE, POS, PRIMITIVES, SOURCES, UDP_PREFIX, Library, evaluate_cell,
    fetch_library, parse_cell, read_library, sha256_file, strip_comments,

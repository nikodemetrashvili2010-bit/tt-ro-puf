...
axL.text(2.0, ARMB-6, "one shared scalar repeated", va="top", ha="center", fontsize=10.5, color=B_GREEN, fontweight="bold")
...
fig.text(0.02, 0.95, "Arm B is a shared nominal reference, not a spread estimate", ha="left", va="top", fontsize=14, fontweight="bold", color="#1a1a1a")

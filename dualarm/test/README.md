...
gate-level netlist, because sky130 gives its combinational cells no delay in
either view it ships, so enabling an Arm A ring there advances no simulated time and
